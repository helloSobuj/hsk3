...
export default function App() {
  ...
  return (
    <div className="flex h-full flex-col md:flex-row bg-slate-50">
      ...
      <div className={`
        fixed inset-0 z-50 md:static md:z-0 flex transition-transform duration-300 transform 
        ...
        <div className="flex flex-col h-full w-64 lg:w-72 bg-white border-r border-slate-200 shadow-xl md:shadow-none flex-shrink-0">
          ...
          <div className="flex items-center justify-between p-4 md:p-6 border-b border-slate-100">
             <div className="flex items-center gap-2">
               <div className={`p-1.5 md:p-2 rounded-lg text-white ${getThemeBg(level)}`}>
                 <GraduationCap className="w-5 h-5 md:w-6 md:h-6" />
               </div>
               <div>
                 <h1 className="font-serif font-bold text-lg md:text-xl text-slate-800 tracking-tight">HanziHero</h1>
                 <p className="text-[10px] md:text-xs text-slate-400 font-medium tracking-wide">HSK MASTERY</p>
               </div>
             </div>
             {/* Mobile Close Button */}
